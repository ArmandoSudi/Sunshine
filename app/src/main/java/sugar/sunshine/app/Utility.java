...
// From wind direction in degrees, determine compass direction as a string (e.g NW)
    ...
    public static int getIconResourceForWeatherCondition(int weatherId) {
        ...
        if (weatherId >= 200 && weatherId <= 232) {
            ...
            return R.drawable.icon_light_clouds;
    ...
    /**
     * Returns true of the network is available or about to become available
     *
    ...
    /**
     *
     * @param c Context used to get the shared preference
     * @return the locations status integer
     */
    ...
    /**
     * Resets the location status. (Sets it to SunshineSyncAdapter.LOCATIONS_STATUS_UNKNOWN)
    ...
    public static void resetLocationStatus(Context c){
        ...
        spe.putInt(c.getString(R.string.pref_location_status_key),
                SunshineSyncAdapter.LOCATION_STATUS_UNKNOWN);
        // Using apply() function since it will be called from the UI thread
        spe.apply();
    }
