...
/**
 * Created by sugar on 22-02-2016.
 */
public class WeatherProvider extends ContentProvider {
    ...
    private Cursor getWeatherByLocationSetting(Uri uri, String[] projection, String sortOrder){
        ...
        // getting the location and date from the Uri
        ...
        // we finally build the string array that will substituted in our query
        if (startDate == 0){
        ...
        // use the string array within our query
    ...
    private Cursor getWeatherByLocationSettingAndDate(
        ...
        // getting the location and date from the uri and pass them in array as param to the query
        String locationSetting = WeatherContract.WeatherEntry.getLocationSettingFromUri(uri);
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        switch (match) {
            ...
            case LOCATION: {
                ...
                if ( _id > 0 )
                    returnUri = WeatherContract.LocationEntry.builLocationUri(_id);
                else
                    throw new android.database.SQLException("Failed to insert row into " + uri);
                break;
            }
        ...
        switch (match) {
            case WEATHER:
                ...
                try {
                    ...
                    // the record will not be committed if we call endTransaction without setting
